...
--
-- Dumping events for database 'busreservationsystem'
--

--
-- Dumping routines for database 'busreservationsystem'
--
/*!50003 DROP PROCEDURE IF EXISTS `Customer_Entry` */;
...
/*!50003 DROP PROCEDURE IF EXISTS `Employee_Entry` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
